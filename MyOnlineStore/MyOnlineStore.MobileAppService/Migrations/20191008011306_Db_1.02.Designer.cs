...
namespace MyOnlineStore.MobileAppService.Migrations
{
    ...
    [Migration("20191008011306_Db_1.02")]
    partial class Db_102
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyOnlineStore.Shared.Models.Purchases.Order", b =>
                {
            ...
            modelBuilder.Entity("MyOnlineStore.Shared.Models.Purchases.Order", b =>
                {
                    b.HasOne("MyOnlineStore.Shared.Models.Stores.Store", "StoreOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("MyOnlineStore.Shared.Models.Purchases.ProductItem", b =>
                {
                    ...
                    b.HasOne("MyOnlineStore.Shared.Models.Purchases.Order", null)
                        .WithMany("OrderItems")
